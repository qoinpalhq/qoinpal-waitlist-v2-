...
const MobileNewsLetter = () => {
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        // Add any additional logic you need, such as sending the email to your backend.
    };
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="w-[358px] h-12 px-6 py-[15px] rounded-[30px] border border-stone-300 justify-start items-center gap-4 inline-flex mb-4">
                            <input
                                type="email"
                                className="text-stone-300 text-xs font-medium font-['Red Hat Display'] leading-[18px] tracking-wide bg-transparent w-full focus:outline-none"
                        ...
                        <div className="w-[358px] h-12 px-3 py-[15.50px] bg-[#CCFB00] rounded-[30px] justify-center items-center gap-2.5 inline-flex mb-10">
                            <button
                                type="submit"
                                className="text-neutral-900 text-sm font-medium font-['Red Hat Display'] leading-[16.80px] tracking-tight"
                            >
                                Join waitlist
                            </button>
                        </div>
